<h3 align="left">Hi, I'm 허영준 👋</h3>

iM뱅크 디지털 행원으로 일하며, 금융 데이터 분석가로 성장하고 있습니다.
...
- **AARRR 기반 iM뱅크 시중은행 진출 전략 분석**
  &nbsp;·&nbsp; Python · pandas · scikit-learn · XGBoost
- **LLM · 다중분류 기반 피부 진단 & 화장품 추천 서비스**
  &nbsp;·&nbsp; PyTorch · GPT-4o · Selenium
- **국내 ETF 주가 예측 모델 & 웹 서비스**
  &nbsp;·&nbsp; Django · XGBoost · MariaDB
